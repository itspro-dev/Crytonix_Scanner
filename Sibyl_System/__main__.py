...
@System.on(system_cmd(pattern=r"ctxinfo", allow_enforcer=True))
async def status(event):
    msg = await event.reply("Conecting to Crytonix System Core.")
    time.sleep(1)
...
@System.on(system_cmd(pattern="crytonix stats"))
...
async def main():
    ...
    if FAILED_TO_LOAD:
        ...
        await System.send_message(Sibyl_logs, "CRYTONIX IS READY!")
