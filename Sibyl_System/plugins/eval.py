...
@System.on(system_cmd(pattern=r"crytonix (exec|execute|x|ex)"))
async def run(event):
...
@System.on(system_cmd(pattern=r"crytonix (ev|eva|eval|py)"))
...
EXAMPLE - `!crytonix x print("OWO")`
Run code using **eval**
CMD - <ev or eva or eval or py> your code
EXAMPLE - `!crytonix eval 1 + 1`
"""
